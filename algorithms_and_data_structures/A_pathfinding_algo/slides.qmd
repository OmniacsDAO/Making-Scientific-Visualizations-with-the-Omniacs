...
📸 *Insert screenshot of initial empty grid here.*
![Grid](/desktop/omniacs/media/images/image.png)
...
📸 *Insert screenshot of the title displayed.*
...
📸 *Insert screenshot of the legend next to the grid.*
...
📸 *Insert screenshot showing grid + start (green) and goal (red) points.*
...
📸 *Insert screenshot showing the grid with walls filled in.*
...
📸 *Insert screenshot during pathfinding showing explored and frontier cells.*
...
📸 *Insert screenshot showing final path traced in purple.*
...
📸 *Insert screenshot showing the formula at the top corner.*
...
📸 *Insert screenshot of full scene with explanation text visible.*
...
✅ Great for classrooms, tutorials, or presentations!

📸 *Insert final screenshot with entire scene completed.*
